...
import signature_img from "../../assets/Signature.svg";
      ...
      <div className="about-container">
        <div className="about-description">
          ...
          <p>
            ...
            asperiores autem deleniti dicta doloribus facere, fuga impedit
            incidunt iusto mollitia nisi odit qui quia quod ratione repellendus
            rerum sit. Ex fugiat maiores sequi voluptatem.
          </p>
          <img src={signature_img} alt="signature" className="signature_img" />
        </div>
        <img
          src={people_img}
          alt="5 persons staying in circle"
